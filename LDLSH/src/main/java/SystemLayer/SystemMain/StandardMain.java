...
public class StandardMain extends SystemMainImp{

    private static final String ui_config = "UI";

    public StandardMain(String[] args, DataContainer appContext) throws Exception {
    ...
    public void run() throws Exception {
        ...
        try{
            ui = Boolean.parseBoolean( appContext.getConfigurator().getConfig(ui_config) );
        }catch (Exception e){
            ui = false;
        }
